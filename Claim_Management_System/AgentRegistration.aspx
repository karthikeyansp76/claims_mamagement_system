<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentRegistration.aspx.cs" Inherits="Claim_Management_System.AgentRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <div class="reg_content">
        <div class="auto-style16">
            <span style="font-size: xx-large"> Agent Registration</span><br />
            <br />
            <br />
            <br />
        </div>
        <table>
            <tr>
                <td>First Name </td>
                <td>
                    <asp:TextBox ID="txtFirstName" placeholder="First Name" runat="server" CssClass="text-style" Width="235px"></asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                <td>Date Of Birth</td>
                <td>
                    <asp:TextBox ID="txtDob" runat="server" CssClass="text-style" TextMode="Date" Width="235px"></asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtContactNumber" placeholder="Contact Number" runat="server" CssClass="text-style" Width="235px"></asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="height: 26px">
                    <asp:TextBox ID="txtAltContactNumber" placeholder="AltContact Number" runat="server" CssClass="text-style" Width="235px"></asp:TextBox>
                </td>
            ...
            <tr>
                <td>Address Line1</td>
                <td>
                    <asp:TextBox ID="txtAds1" runat="server" CssClass="text-style" TextMode="MultiLine" Width="235px" MaxLength="100"></asp:TextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtAds1" CssClass="auto-style25" ValidationGroup="register" ForeColor="Red">Address Cannot be empty</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>Adress Line2</td>
                <td>
                    <asp:TextBox ID="txtAds2" runat="server" CssClass="text-style" TextMode="MultiLine" Width="235px" MaxLength="100"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>City</td>
                <td>
                    <asp:TextBox ID="txtCity" runat="server" CssClass="text-style" Width="235px" MaxLength="50"></asp:TextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtCity" CssClass="auto-style25" ValidationGroup="register" ForeColor="Red">City Cannot be empty</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td style="height: 23px">State</td>
                <td style="height: 23px">
                    <asp:TextBox ID="txtState" runat="server" CssClass="text-style" Width="235px" MaxLength="50"></asp:TextBox>
                </td>
                <td style="height: 23px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtState" CssClass="auto-style25" ValidationGroup="register" ForeColor="Red">State Cannot be empty</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>Zip Code</td>
                <td>
                    <asp:TextBox ID="txtZipCode" runat="server" CssClass="text-style" TextMode="Number" Width="235px" MaxLength="10"></asp:TextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtZipCode" CssClass="auto-style25" ValidationGroup="register" ForeColor="Red">Zip Code Cannot be empty</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
